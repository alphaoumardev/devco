...
class Profile(models.Model):
    ...
    avatar = models.ImageField(upload_to="developers/", blank=True,
                               default="https://res.cloudinary.com/diallo/image/upload/v1647154137/8_fncc3c.jpg")
    cover_image = models.ImageField(upload_to="developers/", blank=True,
                                    default="https://res.cloudinary.com/diallo/image/upload/v1647154140/4-big_sd6hps.jpg")
